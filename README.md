...
A Dockerfile to build [The Go Programming Language](https://golang.org/) 1.9.x rpm for CentOS 6 and 7 using [fedora copr](https://copr.fedoraproject.org/).

The spec file and patch files were copied from https://github.com/jcajka/copr-golang/tree/golang1.8
